...
def set_all_rules(world: AstroneerWorld) -> None:
...
def set_all_entrance_rules(world: AstroneerWorld) -> None:
    # Get all the entrances
    # initial entrance definition
    entrances = [world.get_entrance("Menu to Sylva")]

    # Loop through all the planets to get their entrances
...
def set_completion_condition(world: AstroneerWorld) -> None:
